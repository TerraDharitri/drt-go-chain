...
import (
	...
	"github.com/TerraDharitri/drt-go-chain/node/chainSimulator/components"
	...
	chainSimulatorErrors "github.com/TerraDharitri/drt-go-chain/node/chainSimulator/errors"
	"github.com/TerraDharitri/drt-go-chain/node/chainSimulator/process"
	drtChainSharding "github.com/TerraDharitri/drt-go-chain/sharding"
...
func generateAddressInShard(shardCoordinator drtChainSharding.Coordinator, len int) []byte {
	for {
