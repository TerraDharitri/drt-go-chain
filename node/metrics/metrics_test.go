...
func TestInitConfigMetrics(t *testing.T) {
	...
	cfg := config.EpochConfig{
		EnableEpochs: config.EnableEpochs{
			...
			DCDTNFTCreateOnMultiShardEnableEpoch:                     38,
			MetaDCDTSetEnableEpoch:                                   39,
			AddTokensToDelegationEnableEpoch:                         40,
			MultiDCDTTransferFixOnCallBackOnEnableEpoch:              41,
			...
			DCDTMetadataContinuousCleanupEnableEpoch:                 68,
			...
			DynamicDCDTEnableEpoch:                                   100,
			REWAInMultiTransferEnableEpoch:                           101,
	...
	expectedValues := map[string]interface{}{
		"drt_smart_contract_deploy_enable_epoch":                               uint32(1),
		"drt_built_in_functions_enable_epoch":                                  uint32(2),
		"drt_relayed_transactions_enable_epoch":                                uint32(3),
		"drt_penalized_too_much_gas_enable_epoch":                              uint32(4),
		"drt_switch_jail_waiting_enable_epoch":                                 uint32(5),
		"drt_switch_hysteresis_for_min_nodes_enable_epoch":                     uint32(6),
		"drt_below_signed_threshold_enable_epoch":                              uint32(7),
		"drt_transaction_signed_with_txhash_enable_epoch":                      uint32(8),
		"drt_meta_protection_enable_epoch":                                     uint32(9),
		"drt_ahead_of_time_gas_usage_enable_epoch":                             uint32(10),
		"drt_gas_price_modifier_enable_epoch":                                  uint32(11),
		"drt_repair_callback_enable_epoch":                                     uint32(12),
		"drt_block_gas_and_fee_recheck_enable_epoch":                           uint32(13),
		"drt_staking_v2_enable_epoch":                                          uint32(14),
		"drt_stake_enable_epoch":                                               uint32(15),
		"drt_double_key_protection_enable_epoch":                               uint32(16),
		"drt_dcdt_enable_epoch":                                                uint32(17),
		"drt_governance_enable_epoch":                                          uint32(18),
		"drt_delegation_manager_enable_epoch":                                  uint32(19),
		"drt_delegation_smart_contract_enable_epoch":                           uint32(20),
		"drt_correct_last_unjailed_enable_epoch":                               uint32(21),
		"drt_balance_waiting_lists_enable_epoch":                               uint32(22),
		"drt_return_data_to_last_transfer_enable_epoch":                        uint32(23),
		"drt_sender_in_out_transfer_enable_epoch":                              uint32(24),
		"drt_relayed_transactions_v2_enable_epoch":                             uint32(25),
		"drt_unbond_tokens_v2_enable_epoch":                                    uint32(26),
		"drt_save_jailed_always_enable_epoch":                                  uint32(27),
		"drt_validator_to_delegation_enable_epoch":                             uint32(28),
		"drt_redelegate_below_min_check_enable_epoch":                          uint32(29),
		"drt_increment_scr_nonce_in_multi_transfer_enable_epoch":               uint32(30),
		"drt_scheduled_miniblocks_enable_epoch":                                uint32(31),
		"drt_dcdt_multi_transfer_enable_epoch":                                 uint32(32),
		"drt_global_mint_burn_disable_epoch":                                   uint32(33),
		"drt_compute_reward_checkpoint_enable_epoch":                           uint32(35),
		"drt_dcdt_transfer_role_enable_epoch":                                  uint32(34),
		"drt_scr_size_invariant_check_enable_epoch":                            uint32(36),
		"drt_backward_comp_save_keyvalue_enable_epoch":                         uint32(37),
		"drt_dcdt_nft_create_on_multi_shard_enable_epoch":                      uint32(38),
		"drt_meta_dcdt_set_enable_epoch":                                       uint32(39),
		"drt_add_tokens_to_delegation_enable_epoch":                            uint32(40),
		"drt_multi_dcdt_transfer_fix_on_callback_enable_epoch":                 uint32(41),
		"drt_optimize_gas_used_in_cross_miniblocks_enable_epoch":               uint32(42),
		"drt_correct_first_queued_enable_epoch":                                uint32(43),
		"drt_correct_jailed_not_unstaked_empty_queue_enable_epoch":             uint32(44),
		"drt_fix_oog_return_code_enable_epoch":                                 uint32(45),
		"drt_remove_non_updated_storage_enable_epoch":                          uint32(46),
		"drt_delete_delegator_after_claim_rewards_enable_epoch":                uint32(47),
		"drt_optimize_nft_store_enable_epoch":                                  uint32(48),
		"drt_create_nft_through_exec_by_caller_enable_epoch":                   uint32(49),
		"drt_stop_decreasing_validator_rating_when_stuck_enable_epoch":         uint32(50),
		"drt_front_running_protection_enable_epoch":                            uint32(51),
		"drt_is_payable_by_sc_enable_epoch":                                    uint32(52),
		"drt_cleanup_informative_scrs_enable_epoch":                            uint32(53),
		"drt_storage_api_cost_optimization_enable_epoch":                       uint32(54),
		"drt_transform_to_multi_shard_create_enable_epoch":                     uint32(55),
		"drt_dcdt_register_and_set_all_roles_enable_epoch":                     uint32(56),
		"drt_do_not_returns_old_block_in_blockchain_hook_enable_epoch":         uint32(57),
		"drt_add_failed_relayed_tx_to_invalid_mbs_enable_epoch":                uint32(58),
		"drt_scr_size_invariant_on_builtin_result_enable_epoch":                uint32(59),
		"drt_check_correct_tokenid_for_transfer_role_enable_epoch":             uint32(60),
		"drt_disable_exec_by_caller_enable_epoch":                              uint32(61),
		"drt_fail_execution_on_every_api_error_enable_epoch":                   uint32(62),
		"drt_managed_crypto_apis_enable_epoch":                                 uint32(63),
		"drt_refactor_context_enable_epoch":                                    uint32(64),
		"drt_check_function_argument_enable_epoch":                             uint32(65),
		"drt_check_execute_on_readonly_enable_epoch":                           uint32(66),
		"drt_miniblock_partial_execution_enable_epoch":                         uint32(67),
		"drt_dcdt_metadata_continuous_cleanup_enable_epoch":                    uint32(68),
		"drt_fix_async_callback_args_list_enable_epoch":                        uint32(69),
		"drt_fix_old_token_liquidity_enable_epoch":                             uint32(70),
		"drt_runtime_mem_store_limit_enable_epoch":                             uint32(71),
		"drt_runtime_code_size_fix_enable_epoch":                               uint32(72),
		"drt_set_sender_in_eei_output_transfer_enable_epoch":                   uint32(73),
		"drt_refactor_peers_miniblocks_enable_epoch":                           uint32(74),
		"drt_sc_processorv2_enable_epoch":                                      uint32(75),
		"drt_max_blockchain_hook_counters_enable_epoch":                        uint32(76),
		"drt_wipe_single_nft_liquidity_decrease_enable_epoch":                  uint32(77),
		"drt_always_save_token_metadata_enable_epoch":                          uint32(78),
		"drt_set_guardian_feature_enable_epoch":                                uint32(79),
		"drt_relayed_nonce_fix_enable_epoch":                                   uint32(80),
		"drt_deterministic_sort_on_validators_info_enable_epoch":               uint32(81),
		"drt_keep_exec_order_on_created_scrs_enable_epoch":                     uint32(82),
		"drt_multi_claim_on_delegation_enable_epoch":                           uint32(83),
		"drt_change_username_enable_epoch":                                     uint32(84),
		"drt_auto_balance_data_tries_enable_epoch":                             uint32(85),
		"drt_migrate_datatrie_enable_epoch":                                    uint32(86),
		"drt_consistent_tokens_values_length_check_enable_epoch":               uint32(87),
		"drt_fix_delegation_change_owner_on_account_enable_epoch":              uint32(88),
		"drt_dynamic_gas_cost_for_datatrie_storage_load_enable_epoch":          uint32(89),
		"drt_nft_stop_create_enable_epoch":                                     uint32(90),
		"drt_change_owner_address_cross_shard_through_sc_enable_epoch":         uint32(91),
		"drt_fix_gas_remainig_for_save_keyvalue_builtin_function_enable_epoch": uint32(92),
		"drt_current_randomness_on_sorting_enable_epoch":                       uint32(93),
		"drt_stake_limits_enable_epoch":                                        uint32(94),
		"drt_staking_v4_step1_enable_epoch":                                    uint32(95),
		"drt_staking_v4_step2_enable_epoch":                                    uint32(96),
		"drt_staking_v4_step3_enable_epoch":                                    uint32(97),
		...
		"drt_adaptivity":                                                       "true",
		"drt_max_nodes_change_enable_epoch0_epoch_enable":                      uint32(0),
		"drt_max_nodes_change_enable_epoch0_max_num_nodes":                     uint32(1),
		"drt_max_nodes_change_enable_epoch0_nodes_to_shuffle_per_shard":        uint32(2),
	...
	expectedValues["drt_adaptivity"] = "false"
	expectedValues["drt_hysteresis"] = "0.000000"

	err = InitConfigMetrics(ash, cfg, economicsConfig, genesisNodesConfig, lastSnapshotTrieNodesConfig)
	require.Nil(t, err)

	assert.Equal(t, expectedValues["drt_adaptivity"], keys["drt_adaptivity"])
	assert.Equal(t, expectedValues["drt_hysteresis"], keys["drt_hysteresis"])
}
